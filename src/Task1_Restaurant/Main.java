            ...
            switch (choice) {
                case ABOUT:
                    showMessageDialog(null, "Restaurant name: " + restaurant.getName() + "\n" +
                            "Year of establishment: " + restaurant.getEstablishingYear() + "\n" +
                            "Restaurant age: " + restaurant.getAgeOfRestaurant() + "\n" +
                ...
                case MAKE_A_RESERVATION:
                    String reservationNameRead = showInputDialog("Which name do you want to register\n" +
                            "the reservation on?");
                ...
                case FIND_RESERVED_TABLES:
                    ...
                    for(int i = 0; i < reservedTables.length; i++) {
                        result += "Table nr: " + reservedTables[i] + "\n";
                    }
